app.controller('CPR_DataController', function ($scope, $http) {
    $scope.CPR00100 = {};
    $scope.SelectedLookUp = {};
    $scope.LoadLookUp = function () {
        $http.get('/CPR_Data/GetRecordTypes?KaizenPublicKey=' + sessionStorage.PublicKey)
    ...
    $scope.CPR00101 = {};
    $scope.CPR00100.MainAddress = {};
    $scope.CPR00100.BillAddress = {};
    $scope.CPR00100.ShipAddress = {};
    $scope.CPR00100.StatementAddress = {};
    $scope.SelectedView = {};
    $scope.PagesCPR00100 = [];
    ...
    .finally(function () {
        ...
        if ($scope.DebtorViews.length > 0) {
            //$scope.CPR00100.ViewID = $scope.DebtorViews[0].ViewID;
    ...
    $scope.DebtorViewChanged = function () {
        ...
        //alert(AddressCode);
        //$scope.CPR00100.ViewID = $scope.SelectedLookUp.SelectedDebtorView.ViewID;
        $scope.DebtorMainGridURL = "/Tools/CPR_Data/MainGrid?ViewID=" + $scope.SelectedLookUp.SelectedDebtorView.ViewID + "&KaizenPublicKey=" + sessionStorage.PublicKey;
        //alert($scope.DebtorMainGridURL);
    };
    $scope.LoadCPR00100 = function (DebtorID) {
        if (angular.isUndefined($scope.CPR00100.DebtorID)) {
            $http.get('/CPR_Data/GetSingle?KaizenPublicKey=' + sessionStorage.PublicKey + "&DebtorID=" + DebtorID).success(function (data) {
                $scope.CPR00100 = data;
                if (data.CPR00101 != null) {
                    $scope.CPR00101 = data.CPR00101;
                }
            }).finally(function () {
                $scope.CPR00100.Status = 2;
                if ($scope.CPR00100.BirthDate != null && $scope.CPR00100.BirthDate != '') {
                    $scope.CPR00100.BirthDate = kendoparsetoDate($scope.CPR00100.BirthDate);
                }
                if ($scope.CPR00100.CPRExpiryDate != null && $scope.CPR00100.CPRExpiryDate != '') {
                    $scope.CPR00100.CPRExpiryDate = kendoparsetoDate($scope.CPR00100.CPRExpiryDate);
                }
                if ($scope.CPR00100.CPRIssueDate != null && $scope.CPR00100.CPRIssueDate != '') {
                    $scope.CPR00100.CPRIssueDate = kendoparsetoDate($scope.CPR00100.CPRIssueDate);
                }
                if ($scope.CPR00100.PassportExpiryDate != null && $scope.CPR00100.PassportExpiryDate != '') {
                    $scope.CPR00100.PassportExpiryDate = kendoparsetoDate($scope.CPR00100.PassportExpiryDate);
                }
                if ($scope.CPR00100.PassportIssueDate != null && $scope.CPR00100.PassportIssueDate != '') {
                    $scope.CPR00100.PassportIssueDate = kendoparsetoDate($scope.CPR00100.PassportIssueDate);
                }
                if ($scope.CPR00100.VisaExpiryDate != null && $scope.CPR00100.VisaExpiryDate != '') {
                    $scope.CPR00100.VisaExpiryDate = kendoparsetoDate($scope.CPR00100.VisaExpiryDate);
                }
                if ($scope.CPR00100.ResidentPermitExpiryDate != null && $scope.CPR00100.ResidentPermitExpiryDate != '') {
                    $scope.CPR00100.ResidentPermitExpiryDate = kendoparsetoDate($scope.CPR00100.ResidentPermitExpiryDate);
                }

                if ($scope.CPR00100.PhotoExtension == null)
                    $scope.link = '/Photo/DebtorPhoto/DebtorID.jpg';
                else
                    $scope.link = '/Photo/DebtorPhoto/' + kaizenTrim($scope.CPR00100.DebtorID) + "." + kaizenTrim($scope.CPR00100.PhotoExtension) + "?c=" + Math.random();
                if ($scope.CPR00100.SignatureExtension == null)
                    $scope.Signaturelink = '/Photo/DebtorSignature/DebtorSignature.png';
                else
                    $scope.Signaturelink = '/Photo/DebtorSignature/' + kaizenTrim($scope.CPR00100.DebtorID) + "." + kaizenTrim($scope.CPR00100.SignatureExtension) + "?c=" + Math.random();

                //$scope.CM00104 = { DebtorID: $scope.CPR00100.DebtorID, Status: 1 };
            });
        }
    };
    $scope.LoadCPR00100Page = function (ActionName) {
        removeEntityPage($scope.PagesCPR00100);
    ...
    $scope.AddCPR00100 = function () {
        $scope.LoadCPR00100Page('Create');
        $scope.$apply();
        $scope.Clear();
        $scope.CPR00100.Status = 1;
        $scope.CM00104.Status = 1;
        $scope.CPR00100.IsActive = true;
        $scope.CPR00100.DebtorStatusID = 1;
        ...
        $http.get('/CPR_Data/DebtorAddressTypeFillDropDownList?KaizenPublicKey=' + sessionStorage.PublicKey + '&ContactSourceID=1').success(function (data) {
            $scope.DebtorAddressTypes = data;
        }).finally(function () { });
    };
    $scope.EditCPR00100 = function (DebtorID) {
        $scope.LoadCPR00100Page('Create');
        $scope.LoadCPR00100(DebtorID);
        $scope.AddressPathUrl = "/CPR_Data/DebtorAddress?KaizenPublicKey=" + sessionStorage.PublicKey;
        $http.get('/Adm_Country/FillDropDownList?KaizenPublicKey=' + sessionStorage.PublicKey).success(function (data) {
            $scope.Countries = data;
        }).finally(function () { });
        $http.get('/Adm_City/FillDropDownList?KaizenPublicKey=' + sessionStorage.PublicKey).success(function (data) {
    ...
    $scope.SaveData = function () {
        $scope.CPR00101.DebtorID = $scope.CPR00100.DebtorID;
        $scope.CPR00100.CPR00101 = $scope.CPR00101;
        $http.post('/CPR_Data/SaveData', { 'CPR00100': $scope.CPR00100, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                if ($scope.DebtorAddresses.length > 0) {
                    $http.post('/CPR_Data/SaveDebtorAddresses', { 'CM00104': $scope.DebtorAddresses, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
                        if (data.Status == true) {
                            $.bigBox({
                                title: data.Massage,
    ...
    $scope.UpdateData = function () {
        $scope.CPR00101.DebtorID = $scope.CPR00100.DebtorID;
        $scope.CPR00100.CPR00101 = $scope.CPR00101;
        $http.post('/CPR_Data/UpdateData', { 'CPR00100': $scope.CPR00100, 'PhotoChanged': $scope.PhotoChanged, 'SignatureChanged': $scope.SignatureChanged, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.Print = function () {
        if ($scope.CPR00100.PrintType == "PDF") {
            ...
            .done(function (data) {
                ...
                kendo.saveAs({
                    dataURI: data,
                    fileName: "Debtor ID " + $scope.CPR00100.DebtorID.trim() + ".pdf",
                    proxyURL: "@Url.Action('Pdf_Export_Save')"
                });
            });
        }
        else if ($scope.CPR00100.PrintType == "Image") {
            // Convert the DOM element to a drawing using kendo.drawing.drawDOM
            kendo.drawing.drawDOM($(".widget-body"))
            .then(function (group) {
                // Render the result as a PDF file
            ...
            .done(function (data) {
                ...
                kendo.saveAs({
                    dataURI: data,
                    fileName: "Debtor ID " + $scope.CPR00100.DebtorID.trim() + ".png",
                    proxyURL: "@Url.Action('Pdf_Export_Save')"
                });
            });
        }
        else if ($scope.CPR00100.PrintType == "SVG") {
            // Convert the DOM element to a drawing using kendo.drawing.drawDOM
            kendo.drawing.drawDOM($(".widget-body"))
            .then(function (group) {
                // Render the result as a PDF file
            ...
            .done(function (data) {
                ...
                kendo.saveAs({
                    dataURI: data,
                    fileName: "Debtor ID " + $scope.CPR00100.DebtorID.trim() + ".svg",
                    proxyURL: "@Url.Action('Pdf_Export_Save')"
                });
            });
        }
    ...
    $scope.Delete = function () {
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                $http.post('/CPR_Data/DeleteData', { 'CPR00100': $scope.CPR00100, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
                    if (data.Status == true) {
                        $.bigBox({
                            title: data.Massage,
                            content: data.Description,
    ...
    $scope.ClassChanged = function () {
        $http.get('/CPR_Data/GetNextDebtor?KaizenPublicKey=' + sessionStorage.PublicKey, { params: { CUSTCLAS: $scope.CPR00100.CUSTCLAS } }).success(function (data) {
            $scope.CPR00100.DebtorID = data;
        }).finally(function () { });
    };
    $scope.ActiveChanged = function () {
        if ($scope.CPR00100.IsActive) {
            $scope.CPR00100.IsHold = false;
        } else {
            $scope.CPR00100.IsHold = true;
        }
    };
    $scope.HoldChanged = function () {
        if ($scope.CPR00100.IsHold) {
            $scope.CPR00100.IsActive = false;
        } else {
            $scope.CPR00100.IsActive = true;
        }
    };
    ...
    $scope.DebtorAddressCodeBack = function (addresscode) {
        if (addresscode != null) {
            switch ($scope.CurrentControl) {
                case 'MainAddress':
                    $scope.CPR00100.AddressCode = addresscode.AddressCode;
                    break;
                case 'BillAddress':
                    $scope.CPR00100.BillTo = addresscode.AddressCode;
                    break;
                case 'ShipAddress':
                    $scope.CPR00100.ShipTo = addresscode.AddressCode;
                    break;
                case 'StatementAddress':
                    $scope.CPR00100.StatementTo = addresscode.AddressCode;
                    break;
            }
        }
    };
    $scope.NationalityBack = function (nationality) {
        if (nationality != null) {
            $scope.CPR00100.NationalityID = nationality.NationalityID;
            $scope.CPR00100.NationalityName = nationality.NationalityName;
        }
    };
    $scope.DebtorBack = function (debtor) {
        if (debtor != null) {
            switch ($scope.CurrentControl) {
                case 'ParentDebtor':
                    $scope.CPR00100.ParentDebtor = debtor.DebtorID;
                    break;
                case 'DebtorAddress':
                    $scope.CPR00100 = debtor;
    ...
    $scope.DebtorAddressBack = function (address) {
        if (address != null) {
            switch ($scope.CurrentControl) {
                case 'MainAddress':
                    $scope.CPR00100.AddressCode = address.AddressCode;
                    $scope.CPR00100.MainAddress = address;
                    break;
                case 'BillAddress':
                    $scope.CPR00100.BillTo = address.AddressCode;
                    $scope.CPR00100.BillAddress = address;
                    break;
                case 'StatementAddress':
                    $scope.CPR00100.StatementTo = address.AddressCode;
                    $scope.CPR00100.StatementAddress = address;
                    break;
            }
        }
    };
    ...
    $scope.SetPhotoExtension = function (PhotoPath) {
        $scope.CPR00100.PhotoExtension = PhotoPath;
    ...
    $scope.RemovePhotoExtension = function (PhotoPath) {
        $scope.CPR00100.PhotoExtension = "";
    };

    $scope.SetSignatureExtension = function (PhotoPath) {
        $scope.CPR00100.SignatureExtension = PhotoPath;
    ...
    $scope.RemoveSignatureExtension = function (PhotoPath) {
        $scope.CPR00100.SignatureExtension = "";
    };
    ...
    $scope.SendMessage = function () {
        $scope.LoadCPR00100Page('SendMessage')
        $scope.Clear();
        $scope.CPR00100.Status = 1;
...
"print"
        ...
        $scope.LoadCPR00100Page('SendEmails');
        $scope.selectedIds = ["Email01"];
        $scope.CM00104.status = 0;
        $http.get('/CPR_Data/DebtorAddressTypeFillDropDownList?KaizenPublicKey=' + sessionStorage.PublicKey).success(function (data) {
            $scope.AddressTypes = data;
        }).finally(function () { });
    ...
    $scope.DebtorContact = function () {
        removeEntityPage($scope.PagesCPR00100);
        $scope.LoadCPR00100Page('DebtorContact');
    ...
    $scope.SaveDebtorContact = function () {
        ...
        $scope.CM00106.DebtorID = $scope.CPR00100.DebtorID;
        $http.post('/CPR_Data/SaveDebtorContact', { 'CM00106': $scope.CM00106, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.UpdateDebtorContact = function () {
        $scope.CM00106.DebtorID = $scope.CPR00100.DebtorID;
        $http.post('/CPR_Data/UpdateDebtorContact', { 'CM00106': $scope.CM00106, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.DeleteDebtorContact = function () {
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                $http.post('/CPR_Data/DeleteDebtorContact', { 'CM00106': $scope.CM00106, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
                    if (data.Status == true) {
                        $.bigBox({
                            title: data.Massage,
                            content: data.Description,
    ...
    $scope.DebtorAddress = function () {
        removeEntityPage($scope.PagesCPR00100);
        $scope.LoadCPR00100Page('DebtorAddress');
        $scope.CM00104.Status = 1;
        $http.get('/CPR_Data/DebtorAddressTypeFillDropDownList?KaizenPublicKey=' + sessionStorage.PublicKey + '&ContactSourceID=1').success(function (data) {
            $scope.DebtorAddressTypes = data;
        }).finally(function () { });
    ...
    $scope.SaveDebtorAddress = function () {
        ...
        $scope.CM00104.DebtorID = $scope.CPR00100.DebtorID;
        $http.post('/CPR_Data/SaveDebtorAddress', { 'CM00104': $scope.CM00104, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.UpdateDebtorAddress = function () {
        $scope.CM00104.DebtorID = $scope.CPR00100.DebtorID;
        $http.post('/CPR_Data/UpdateDebtorAddress', { 'CM00104': $scope.CM00104, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.DeleteDebtorAddress = function () {
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                $http.post('/CPR_Data/DeleteDebtorAddress', { 'CM00104': $scope.CM00104, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
                    if (data.Status == true) {
                        $.bigBox({
                            title: data.Massage,
                            content: data.Description,
    ...
    $scope.DebtorDocument = function () {
        removeEntityPage($scope.PagesCPR00100);
        $scope.LoadCPR00100Page('DebtorDocument');
    ...
    $scope.SaveDebtorDocument = function () {
        ...
        var dataSourceData = grid.dataSource.data();
        $scope.CM00101.DebtorID = $scope.CPR00100.DebtorID;
        $http.post('/CPR_Data/SaveDebtorDocument', { 'CM00101': $scope.CM00101, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.UpdateDebtorDocument = function () {
        $scope.CM00101.DebtorID = $scope.CPR00100.DebtorID;
        $http.post('/CPR_Data/UpdateDebtorDocument', { 'CM00101': $scope.CM00101, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
            if (data.Status == true) {
                $.bigBox({
                    title: data.Massage,
                    content: data.Description,
    ...
    $scope.DeleteDebtorDocument = function () {
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                $http.post('/CPR_Data/DeleteDebtorDocument', { 'CM00101': $scope.CM00101, 'KaizenPublicKey': sessionStorage.PublicKey }).success(function (data) {
                    if (data.Status == true) {
                        $.bigBox({
                            title: data.Massage,
                            content: data.Description,
    ...
    $scope.UploadDebtor = function () {
        $scope.LoadCPR00100Page('UploadDebtor');
        $scope.Clear();
    };
    ...
    //    $scope.CPR00100 = {};
    //    $scope.CM00104 = {};
    //    $scope.LoadCPR00100(row.DebtorID);
    //    $scope.DetailsWindow.center().toFront().open();
    //    $scope.DetailsWindow.refresh({
    //        url: "/CPR_Data/DebtorDetails?KaizenPublicKey=" + sessionStorage.PublicKey
    //    });
    //};
