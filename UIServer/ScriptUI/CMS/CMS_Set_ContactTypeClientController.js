app.controller('CMS_Set_ContactTypeClientController', function ($scope, $http) {
    $scope.Sys00006 = {};
    $scope.PagesSys00006 = [];
...
, resizable: true
    ...
    $scope.SaveData = function () {
        $http.post('/Admin_ContactType/SaveData', {
            'Sys00006': $scope.Sys00006, 'ContactSourceID': 1, 'KaizenPublicKey': sessionStorage.PublicKey
