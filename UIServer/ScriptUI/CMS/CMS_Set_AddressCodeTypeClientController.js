app.controller('CMS_Set_AddressCodeTypeClientController', function ($scope, $http) {
    $scope.CM00008 = {};
    $scope.CM00009 = {};
    $scope.CM00033 = {};
    $scope.CM00034 = {};
    ...
    $scope.LoadCM00008 = function (AddressCode) {
    ...
    $scope.LoadCM00008Page = function (ActionName) {
        removeEntityPage($scope.PagesCM00008);
...
, resizable: true
    ...
    $scope.selectedType = {};
    $scope.selectedType.value = "Client";
    $scope.Type_Changed();

    $scope.AddCM00008 = function () {
        $scope.LoadCM00008Page('Create');
        $scope.Clear();
    ...
    $scope.EditAddressType = function (AddressCodeType) {
        $scope.LoadCM00008Page('Create');
        $scope.Clear();
        $scope.LoadCM00008(AddressCodeType);
    };
