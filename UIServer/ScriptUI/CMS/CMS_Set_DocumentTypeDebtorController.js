app.controller('CMS_Set_DocumentTypeDebtorController', function ($scope, $http) {
    $scope.Sys00007 = {};
    $scope.PagesSys00007 = [];
...
, resizable: true
    ...
    $scope.SaveData = function () {
        $http.post('/Admin_DocumnetType/SaveData', {
            'Sys00007': $scope.Sys00007, 'ContactSourceID': 2, 'KaizenPublicKey': sessionStorage.PublicKey
