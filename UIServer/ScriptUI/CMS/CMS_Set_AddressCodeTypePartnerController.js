app.controller('CMS_Set_AddressCodeTypePartnerController', function ($scope, $http) {
    $scope.CM00008 = {};
    $scope.CM00009 = {};
    $scope.CM00033 = {};
    $scope.CM00034 = {};
    ...
    $scope.LoadCM00033 = function (AddressCode) {
    ...
    $scope.LoadCM00033Page = function (ActionName) {
        removeEntityPage($scope.PagesCM00033);
...
, resizable: true
    ...
    $scope.selectedType = {};
    $scope.selectedType.value = "Partner";
    $scope.Type_Changed();

    $scope.AddCM00033 = function () {
        $scope.LoadCM00033Page('Create');
        $scope.Clear();
    ...
    $scope.EditAddressType = function (AddressCodeType) {
        $scope.LoadCM00033Page('Create');
        $scope.Clear();
        $scope.LoadCM00033(AddressCodeType);
    };
