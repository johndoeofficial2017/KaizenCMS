...
namespace UIServer.Infrastructure.Token_Setup
{
    internal class KaizenReplacerSnippet
    {
        ...
        public KaizenReplacerSnippet(string text)
        {
            this.Text = text;
        ...
        public void Append(KaizenReplacerSnippet snippet)
        {
        ...
        public void Replace(int start, int end, KaizenReplacerSnippet snippet)
        {
            InnerSnippets.Add(new InnerSnippet
            {
                Snippet = snippet,
        ...
        public void InsertBefore(int start, KaizenReplacerSnippet snippet)
        {
            InnerSnippets.Add(new InnerSnippet
            {
                Snippet = snippet,
        ...
        public void InsertAfter(int end, KaizenReplacerSnippet snippet)
        {
            InnerSnippets.Add(new InnerSnippet
            {
                Snippet = snippet,
