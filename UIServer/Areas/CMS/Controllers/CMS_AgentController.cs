...
{
    public class CMS_AgentController : Controller
    {
        // GET: CMS_Agent
        ...
        public ActionResult TargetAssignment(string KaizenPublicKey)
        {
            Kaizen.Configuration.KaizenSession KaizenUser = UserServices.GetKaizenSession(KaizenPublicKey);
            if (KaizenUser == null) return RedirectToAction("LoginToCompany", "SysUser");
            return PartialView();
...
, string FieldID, int FltrOperator, string Searchcritaria)
        ...
        public ActionResult DistributionRule(string KaizenPublicKey)
        {
            Kaizen.Configuration.KaizenSession KaizenUser = UserServices.GetKaizenSession(KaizenPublicKey);
            if (KaizenUser == null) return RedirectToAction("LoginToCompany", "SysUser");
            return PartialView();
        }
        public ActionResult SaveWhereCondition(string AgentID,string WhereCondition, string KaizenPublicKey)
        {
            Kaizen.Configuration.KaizenSession KaizenUser = UserServices.GetKaizenSession(KaizenPublicKey);
            if (KaizenUser == null) return RedirectToAction("LoginToCompany", "SysUser");
            CM00105Services service = new CM00105Services(KaizenUser);
            CM00105 CM00105 = service.GetSingle(AgentID);
            CM00105.WhereCondition = WhereCondition;
            return Json(service.Update(CM00105), JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult SaveTargetInfo(IList<CM00107> CM00107, string KaizenPublicKey)
        {
            ...
            if (KaizenUser == null) return RedirectToAction("LoginToCompany", "SysUser");
            CM00107Services service = new CM00107Services(KaizenUser);
            return Json(service.Update(CM00107), JsonRequestBehavior.AllowGet);
        }
        #endregion
...
, string FieldID, int FltrOperator, string AgentID, string Searchcritaria)
        ...
        public ActionResult AgentCaseStatus(string KaizenPublicKey)
        {
            Kaizen.Configuration.KaizenSession KaizenUser = UserServices.GetKaizenSession(KaizenPublicKey);
            if (KaizenUser == null)
                return RedirectToAction("LoginToCompany", "SysUser");
        ...
        public ActionResult GetAgentCaseStatus(string KaizenPublicKey)
        {
            Kaizen.Configuration.KaizenSession KaizenUser = UserServices.GetKaizenSession(KaizenPublicKey);
            if (KaizenUser == null) return RedirectToAction("LoginToCompany", "SysUser");
            CM00105Services service = new CM00105Services(KaizenUser);
            IList<CM00203> L = service.GetAgentCaseStatus();
            return Json(L, JsonRequestBehavior.AllowGet);
        }
        public ActionResult GetAllAgents(string KaizenPublicKey)
        {
            Kaizen.Configuration.KaizenSession KaizenUser = UserServices.GetKaizenSession(KaizenPublicKey);
            if (KaizenUser == null) return RedirectToAction("LoginToCompany", "SysUser");
            CM00105Services service = new CM00105Services(KaizenUser);
            IList<CM00105> L = service.GetAllAgents();
            return Json(L, JsonRequestBehavior.AllowGet);
        }
        #endregion
    }
