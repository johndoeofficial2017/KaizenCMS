...
{
    public class CM10207Services
    {
        #region Infrastructure

        private Kaizen.CMS.Repository.CM10207Repository _CM10207Repository;
        private Kaizen.Configuration.KaizenSession UserContext;
        public CM10207Services(Kaizen.Configuration.KaizenSession _UserContext)
        {
            UserContext = _UserContext;
            _CM10207Repository = new Kaizen.CMS.Repository.CM10207Repository(UserContext.CompanyID, UserContext.UserName, UserContext.Password);

        }
        #endregion
        public DataCollection<CM10207> GetAllViewBYSQLQuery(string Filters, string Searchcritaria,
int PageSize, int Page, string Member, bool IsAscending)
        {
            ...
            if (string.IsNullOrEmpty(SeachStr))
                ...
                result = rep.GetWhereListWithPaging("CM10207", PageSize, Page, SeachStr, Member, IsAscending);
            return result;
        }

        public DataCollection<CM10207> GetAllViewBYSQLQuery(string Filters,
...
int PageSize, int Page, string Member, bool IsAscending)
        {
            ...
            DataCollection<CM10207> result = null;
            if (string.IsNullOrEmpty(SeachStr))
                result = _CM10207Repository.GetWhereListWithPaging(PageSize, Page, ss => Member, IsAscending);
            else
                result = _CM10207Repository.GetWhereListWithPaging("CM10207", PageSize, Page, SeachStr, Member, IsAscending);
            return result;
        }
...
int PageSize, int Page, string Member, bool IsAscending)
        ...
        public DataCollection<CM10207> GetAllBYSQLQuery(string sqlenquiry, int PageSize, int Page, string Member, string SortDirection)
        {
            IList<CM10207> L = null;
            var tasks = _CM10207Repository.GetListWithPaging(sqlenquiry, PageSize, Page, ss => Member, ss => SortDirection);
            DataCollection<CM10207> result = tasks;
            return result;
        }
        public DataCollection<CM10207> GetListWithPaging(int PageSize, int Page, string Member, string SortDirection)
        {
            DataCollection<CM10207> result = null;
            var tasks = _CM10207Repository.GetListWithPaging(PageSize, Page, ss => new { ss.PaymentID });
            result = tasks;
            return result;
        }

        public IList<CM10207> GetAll()
        {
            try
            {
                IList<CM10207> L = null;
                try
                {
                    var tasks = _CM10207Repository.GetAll();
                    IList<CM10207> result = tasks;
                    return result;
                }
                catch (Exception ex)
                {
        ...
        public CM10207 GetSingle(string PaymentID)
        {
            try
            {
                var tasks = _CM10207Repository.GetSingle(x => x.PaymentID == PaymentID);
                return tasks;
            }
            catch (System.Data.Entity.Validation.DbEntityValidationException e)
            {
        ...
        public IList<CM10207> GetAllByCaseRef(string CaseRef)
        {
            var tasks = _CM10207Repository.GetAll();
            IList<CM10207> result = tasks;
            return result;
        }
        public KaizenResult AddCM10207(CM10207 newTask, List<CM00204> CM00204)
        {
            ...
            using (TransactionScope txScope = new TransactionScope())
            {
                ...
                result = _CM10207Repository.AddKaizenObject(newTask);
                if (result.Status)
                {
                    ...
                    //    sql += where;
                    //    _CM10207Repository.ExecuteSqlCommand(sql);
                    //}
                    if (result.Status)
                        txScope.Complete();
                }
        ...
        {
            KaizenResult result = _CM10207Repository.RemoveKaizenObject(xx => xx.PaymentID.Trim() == PaymentID.Trim());
            return result;
        }

        public KaizenResult AddCM10207(CM10207 newTask)
        {
            newTask.CreatedDate = DateTime.Now;
            newTask.CreatedBy = this.UserContext.UserName;
            newTask.IsApproved = false;
            KaizenResult result = _CM10207Repository.AddKaizenObject(newTask);
            return result;
        }
        public KaizenResult AddCM10207(IList<CM10207> newTask)
        {
            ...
            KaizenResult result = _CM10207Repository.AddKaizenObject(newTask.ToArray());
            //if (result.Status)
            //{
        ...
        public KaizenResult PostBatch(List<CM10207> CM10207List)
        {
            KaizenResult result=new KaizenResult();
            IList<CM10207> updateObjList = new List<CM10207>();
            foreach (CM10207 obj in CM10207List)
            {
                CM00207Services service = new CM00207Services(this.UserContext);
                result = service.PostSingle(obj.PaymentID);
                //CM10207 objToUpdate = _CM10207Repository.GetAll().Where(x => x.PaymentID.Trim().Equals(obj.PaymentID.Trim())).FirstOrDefault();
                //objToUpdate.IsApproved = obj.IsApproved;
                //updateObjList.Add(objToUpdate);
            }
            //if (result.Status)
            //{
            //    Configuration.CompanyacessServices src = new Configuration.CompanyacessServices(UserContext);
        ...
        public KaizenResult ApproveDataObject(IList<CM10207> CM10207List)
        {
            IList<CM10207> updateObjList = new List<CM10207>();
            foreach(CM10207 obj in CM10207List)
            {
            ...
            KaizenResult result = _CM10207Repository.UpdateKaizenObject(updateObjList.ToArray());
            //if (result.Status)
            //{
            //    Configuration.CompanyacessServices src = new Configuration.CompanyacessServices(UserContext);
            //    src.DeleteNextPaymentID();
        ...
        public KaizenResult Update(CM10207 newTask)
        {
            KaizenResult result = _CM10207Repository.UpdateKaizenObject(newTask);
            return result;
        }
        public KaizenResult UpdatePost(CM10207 newTask)
        {
            KaizenResult result = _CM10207Repository.UpdateKaizenObject(newTask);
            string sql = "exec CMS_PaymentPost '"+ newTask.PaymentID.Trim() + "'";
            if(_CM10207Repository.ExecuteSqlCommand(sql) == 0)
            {
                result.Status = false;
                result.Massage = "Failed to Save Data";
            }
        ...
        public KaizenResult Update(IList<CM10207> newTask)
        {
            KaizenResult result = _CM10207Repository.UpdateKaizenObject(newTask.ToArray());
            return result;
        }
        public KaizenResult Delete(CM10207 newTask)
        {
            KaizenResult result = _CM10207Repository.DeleteKaizenObject(newTask);
            return result;
        }
        public KaizenResult Delete(IList<CM10207> newTask)
        {
            KaizenResult result = _CM10207Repository.DeleteKaizenObject(newTask.ToArray());
            return result;
        }
        ...
        public string GetNextPaymentID()
        {
            ...
            if(KaizenID == 0)
            {
                ...
                long? SequenceNumber = _CM10207Repository.GetSQLLong(SQL);
        ...
        {
            var result = _CM10207Repository.ExecuteSqlCommand(myQuery);
            return result;
        }
    }
}
