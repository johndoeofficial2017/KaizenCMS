...
{
    public class SOP10200Map : EntityTypeConfiguration<SOP10200>
    {
        public SOP10200Map()
        {
            // Primary Key
            this.HasKey(t => new { t.SOPNUMBE, t.SOPTypeSetupID });
            ...
            this.Property(t => t.QuoteExpirationDate).HasColumnName("QuoteExpirationDate");
