...
{
    public class SOP10201Map : EntityTypeConfiguration<SOP10201>
    {
        public SOP10201Map()
        {
            // Primary Key
            ...
            this.Property(t => t.QuantityShort).HasColumnName("QuantityShort");
            ...
            this.HasOptional(t => t.IV00100)
                .WithMany(t => t.SOP10201)
                .HasForeignKey(d => d.ItemID);
            this.HasOptional(t => t.PROJ00100)
                .WithMany(t => t.SOP10201)
                .HasForeignKey(d => d.ProjectID);
            this.HasOptional(t => t.SOP00024)
                .WithMany(t => t.SOP10201)
                .HasForeignKey(d => d.ShippingID);
            this.HasRequired(t => t.SOP10200)
                .WithMany(t => t.SOP10201)
                .HasForeignKey(d => new { d.SOPNUMBE, d.SOPTypeSetupID });
            this.HasOptional(t => t.SOP10202)
                .WithMany(t => t.SOP10201)
