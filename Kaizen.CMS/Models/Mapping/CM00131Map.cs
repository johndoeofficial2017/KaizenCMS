...
{
    public class CM00131Map : EntityTypeConfiguration<CM00131>
    {
        public CM00131Map()
        {
            // Primary Key
            this.HasKey(t => new { t.AddressCodeType, t.PartnerID });
            ...
            // Relationships
            this.HasRequired(t => t.CM00033)
                .WithMany(t => t.CM00131)
                .HasForeignKey(d => d.AddressCodeType);
            this.HasRequired(t => t.CM00130)
                .WithMany(t => t.CM00131)
