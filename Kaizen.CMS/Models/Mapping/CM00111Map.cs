...
{
    public class CM00111Map : EntityTypeConfiguration<CM00111>
    {
        public CM00111Map()
        {
            // Primary Key
            this.HasKey(t => new { t.AddressCode, t.ClientID });
            ...
            // Relationships
            this.HasRequired(t => t.CM00008)
                .WithMany(t => t.CM00111)
