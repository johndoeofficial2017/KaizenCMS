...
{
    public class CM00155Map : EntityTypeConfiguration<CM00155>
    {
        public CM00155Map()
        {
            // Primary Key
            ...
            this.Property(t => t.CaseStatusnameNew)
                .HasMaxLength(50);

            this.Property(t => t.CaseStatusChildNameNew)
                .HasMaxLength(50);

            this.Property(t => t.CaseStatusCommentNew)
                .HasMaxLength(1000);
            ...
            this.Property(t => t.CaseStatusIDNew).HasColumnName("CaseStatusIDNew");
            this.Property(t => t.CaseStatusChildNew).HasColumnName("CaseStatusChildNew");
            this.Property(t => t.CaseStatusnameNew).HasColumnName("CaseStatusnameNew");
            this.Property(t => t.CaseStatusChildNameNew).HasColumnName("CaseStatusChildNameNew");
            this.Property(t => t.CaseStatusCommentNew).HasColumnName("CaseStatusCommentNew");
            this.Property(t => t.ReminderDateTimeNew).HasColumnName("ReminderDateTimeNew");
            this.Property(t => t.PTPAMTNew).HasColumnName("PTPAMTNew");
