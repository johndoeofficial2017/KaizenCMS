...
namespace Kaizen.CMS
{
    public partial class CM00155
    {
        ...
        public Nullable<int> CaseStatusIDNew { get; set; }
        public Nullable<int> CaseStatusChildNew { get; set; }
        public string CaseStatusnameNew { get; set; }
        public string CaseStatusChildNameNew { get; set; }
        public string CaseStatusCommentNew { get; set; }
        public Nullable<System.DateTime> ReminderDateTimeNew { get; set; }
        public Nullable<double> PTPAMTNew { get; set; }
