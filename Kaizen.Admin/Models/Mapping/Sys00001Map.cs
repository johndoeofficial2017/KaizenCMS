...
{
    public class Sys00001Map : EntityTypeConfiguration<Sys00001>
    {
        public Sys00001Map()
        {
            // Primary Key
            this.HasKey(t => t.CompanyAddressCode);

            // Properties
            this.Property(t => t.CompanyAddressCode)
                .IsRequired()
                .IsFixedLength()
                .HasMaxLength(10);

            this.Property(t => t.CompanyAddressName)
                .IsRequired()
                .HasMaxLength(50);
            ...
            this.ToTable("Sys00001");
            this.Property(t => t.CompanyAddressCode).HasColumnName("CompanyAddressCode");
            this.Property(t => t.CompanyAddressName).HasColumnName("CompanyAddressName");
